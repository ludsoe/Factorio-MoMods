...
local BlankImage = {filename = "__moindustry__/graphics/empty_dot.png",priority = "low",width = 1,height = 1,frame_count = 1,animation_speed = 0.5}
...
data:extend({
{
    ...
    radius_visualisation_picture = { filename = "__moindustry__/graphics/roboport-mining-radius-visualization.png",width = 12, height = 12},
    construction_radius_visualisation_picture = {filename = "__moindustry__/graphics/roboport-mining-radius-visualization.png", width = 12, height = 12 },
