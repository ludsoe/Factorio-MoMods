...
--Adds a powerful weapon for late game.
M.BFG = true
...
--Adds forcefield posts that generate a regenerative wall that damages attackers. Requires energy.
M.ForceFields = true
...
--Adds Higher Tiers of power armor modules.
M.PowerArmorMods = true
